...
class ExaminationsController {
  ...
  async deleteSingleExamination(req, res) {
    const deletedExamination = await examinationsService.deleteSingleExamination(
      req.params.examId,
      req.query
    );
  ...
  async addSingleExamination(req, res) {
    try {
      const serviceResponse = await examinationsService.addSingleExamination(
        req.body
      );
  ...
  async updateSingleExamination(req, res) {
    try {
      const updateResponse = await examinationsService.updateSingleExamination(
        req.params.examId,
        req.body
      );
